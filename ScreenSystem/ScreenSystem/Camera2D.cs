...
namespace ScreenSystem.ScreenSystem
{
    public abstract class Camera2D
    {
        ...
        protected Vector2 _maxPosition;
        protected float _maxRotation;
        protected Vector2 _minPosition;
        protected float _minRotation;
        protected bool _positionTracking;
        private Matrix _projection;
        protected bool _rotationTracking;
        ...
        public Vector2 ConvertScreenToWorldAndDisplayUnits(Vector2 location)
        {
            return ConvertUnits.ToDisplayUnits(ConvertScreenToWorld(location));
        }
