...
namespace FarseerPhysics.SamplesFramework
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        private void CheckIfAppHaseFocus()
        {
            if (!Game.IsActive)
            {
                var screen = _screens[_screens.Count - 1] as PhysicsGameScreen;
                if (screen != null)
                {
        ...
        public void UpdateGameScreenResoltion()
        {
            foreach (GameScreen screen in _screens)
            {
        ...
        public void AddPauseScreen(PauseScreen pasuescreen)
        {
            var screen = _screens[_screens.Count-1] as PauseScreen;
            //////////////////////////////////////
